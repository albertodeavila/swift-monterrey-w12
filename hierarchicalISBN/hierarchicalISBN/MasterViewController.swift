...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(sender: AnyObject, newBook: Book) {
        ...
        newManagedObject.setValue(newBook.isbn, forKey: "isbn")
        newManagedObject.setValue(newBook.name, forKey: "name")
        newManagedObject.setValue(newBook.authors, forKey: "authors")
        newManagedObject.setValue(newBook.image, forKey: "image")
        newManagedObject.setValue(newBook.imageURL, forKey: "imageURL")
